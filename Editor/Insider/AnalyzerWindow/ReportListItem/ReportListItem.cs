...
{
    class ReportListItem : VisualElement
    {
        const string k_Uxml = "Packages/com.unity.2d.sprite-atlas-analyzer/Editor/Insider/AnalyzerWindow/ReportListItem/ReportListItem.uxml";
        Label m_NameLabel;
        Label m_CountLabel;
        bool m_IsLoading;
        ...
        public void SetName(string name) => m_NameLabel.text = name;
        ...
        public new class UxmlFactory : UxmlFactory<ReportListItem, UxmlTraits> { }
