...
namespace UnityEditor.U2D.SpriteAtlasAnalyzer
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.2d.sprite-atlas-analyzer/Editor/Insider/AnalyzerWindow/DataSourceListItem/DataSourceListItem.uxml";
        ...
        public DataSourceListItem()
        {
            ...
            {
                // ListView.allowRemove is unavailable in Unity 2022.3; footer visibility is controlled via UXML.
            };
