    ...
    class AtlasPageIssue : AnalyzerIssueReportBase
    {
        ...
        void SetupColumns()
        {
            ...
            MultiColumnViewCompat.SetColumnComparison(m_Columns[0], (a, b) =>
            {
                ...
                return string.Compare(itemA.atlasInfo.name, itemB.atlasInfo.name, StringComparison.OrdinalIgnoreCase);
            });
            ...
            {
                (e as CellLabelWithIcon).SetLabelText(m_Filtered[i].pageCount.ToString());
            };
            MultiColumnViewCompat.SetColumnComparison(m_Columns[1], (a, b) =>
            {
                return m_Filtered[a].pageCount.CompareTo(m_Filtered[b].pageCount);
            });
        ...
        async Task<List<AtlasPageIssueRecord>> FilterDataAsync(List<EditorAtlasInfo> dataSource)
        {
            ...
            for(int i = 0; i < dataSource.Count; ++i)
            {
                ...
                {
                    spriteCount += textureInfo.spriteInfo?.Count ?? 0;
                ...
                if ((atlasInfo.textureInfo == null && spriteCount >0) ||
