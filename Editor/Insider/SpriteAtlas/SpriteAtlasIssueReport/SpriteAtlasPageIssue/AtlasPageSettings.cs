...
namespace UnityEditor.U2D.SpriteAtlasAnalyzer
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.2d.sprite-atlas-analyzer/Editor/Insider/SpriteAtlas/SpriteAtlasIssueReport/SpriteAtlasPageIssue/AtlasPageReportSettings.uxml";
